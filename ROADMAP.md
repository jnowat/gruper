...
· WP-01 ✅ · WP-02 ✅ · WP-03 ✅ code complete (live relay leg in WP-06) · WP-04 ✅ code complete (dispatcher + tasks router + timeout watchdog + smoke tests + result relay) · WP-05 ✅ complete (console + console WS relay; `npm ci`/build/check green; Windows installer build fixed and armed) · WP-06 🔄 next · OQ-1 and OQ-2 resolved · **v1.0 is a future finish line gated on SC-1…SC-7; it has not been reached.**
